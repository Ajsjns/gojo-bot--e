...
handler.all = async function (m, conn) {
    ...
    const txt = '*مرت مطورى القمر 🧸❤️*';
    const txt1 = `*وشتبي من مطوري ي @${m.sender.split('@')[0]} 🧞*`;
    const txt2 = `*ايوا ي @${m.sender.split('@')[0]} وشتبي من مرت مطوري 🧞*`;
    const txt3 = `*ايوا ي @${m.sender.split('@')[0]} عاوز أي 🧞*`;
    const txt4 = '*احمم أنا هنا ي مطوري 🧞❤️*';
    const txt5 = '*احمم أنا هنا ي مرات مطوري 🧸❤️*';
    const txt6 = '*ايوا يعم ولعانه معاك حب براحتك وانا براقب 🧸❤️*';
